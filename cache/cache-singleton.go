...
func CreateSingletonCache[T any](client ICommonCache, expiration time.Duration, key string) ISingletonCache[T] {
	return &cacheSingleton[T]{
		base: CreateKvCache[T, string](client, expiration, func(k string) string {
			return k
		}),
		key: key,
	}
